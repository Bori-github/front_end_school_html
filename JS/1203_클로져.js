...
function myFunction2() {
  ...
  return {
    ...
    getVal1: function () {
      ...
      return val2; // 함수니까 리턴을 할 수 있잖아요 그런데 val1을 리턴해줘요
    },
  };
}
...
console.log(result.getVal1()); // hello
// 원래대로라면 저 val1은 외부에서 접근하지 못하는건데, 클로저를 통해서  getVal1을 통해서만 val1에 접근할 수 있게 할 수 있습니다
